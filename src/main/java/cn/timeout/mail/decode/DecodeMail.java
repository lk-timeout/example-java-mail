...
/**
 * @author timeout
 * @Date 2018年10月26日 下午3:14:57
 * @ClassName DecodeMail
 * @Description 解码收取的邮件
 *
 */
public class DecodeMail {
	...
	private String saveAttachPath = "E:\\mail\\"; // 附件下载后的存放目录
	private StringBuffer bodyText = new StringBuffer(); // 存放邮件内容的StringBuffer对象
	private String dateFormat = "yy-MM-dd HH:mm:ss"; // 默认的日前显示格式

	/**
	 * 构造函数,初始化一个DecodeMail对象
	 */
	public DecodeMail() {
	}
	...
	public void saveAttachMent(Part part) throws Exception {
		System.out.println("9999999999" + part.getFileName());
		String fileName = "";
